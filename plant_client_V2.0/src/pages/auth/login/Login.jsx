...
import { useGithubLoginMutation, useGoogleLoginMutation, useLoginMutation } from "../../../features/auth/authApi";

const Login = () => {
  const [googleLogin, { isSuccess: isGoogleLoginSuccess, responseError: googleResponseError }] =
    useGoogleLoginMutation();
  const [githubLogin, { isSuccess: isGitHubLoginSuccess }] = useGithubLoginMutation();
  const MAXLENGTH = 50;
            ...
            <div className="flex-shrink-0 w-full rounded-2xl shadow-2xl lg:px-28 bg-white bg-opacity-30 p-8">
              ...
              <div className="mt-4 text-center">
                <p className="text-[16px]">
                  ...
                  <Link to="/signup">
                    <span className="text-[12px] ml-2 underline text-blue-600 font-bold">Sign Up</span>
                  </Link>
                </p>
