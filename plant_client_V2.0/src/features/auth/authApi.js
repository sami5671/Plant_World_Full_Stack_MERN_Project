    ...
    register: builder.mutation({
      ...
      async onQueryStarted(arg, { queryFulfilled, dispatch }) {
        try {
          ...
          localStorage.setItem("auth", JSON.stringify({ user: result.data.data.user, token }));
    ...
    login: builder.mutation({
      ...
      async onQueryStarted(arg, { queryFulfilled, dispatch }) {
        try {
          ...
          const user = result.data.data.data; // actual user
          const token = result.data.data.token; // actual token
    ...
    socialLogin: builder.mutation({
      ...
      async onQueryStarted(arg, { queryFulfilled, dispatch }) {
        try {
          ...
          localStorage.setItem("auth", JSON.stringify({ user: result.data.data, token }));
